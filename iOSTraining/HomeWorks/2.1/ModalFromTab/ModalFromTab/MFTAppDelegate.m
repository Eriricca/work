...
{
    if (viewController == _tabBarController.viewControllers[1])
    {
        MFTModalViewController *mftModalViewController = [[MFTModalViewController alloc] init];
        [self.tabBarController presentViewController:mftModalViewController animated:YES completion:nil];
        return NO;
    }
    return YES;
}
